...
export const Promo = () => {
  return (
    <div className={cls.promo} style={{ "backgroundImage": `url(${PromoBg})` }}>
      ...
      <Button className={cls.promoButton}>
        Личный кабинет
      </Button>
      <svg className={classNames('curves', {}, [cls.curved])} xmlns="http://www.w3.org/2000/svg" width="492" height="606" viewBox="0 0 492 606" fill="none">
        <path d="M7.65591 460.8C88.0398 542.021 260.392 672.483 306.728 544.567C364.649 384.672 187.96 321.605 241.92 225.299C295.879 128.993 507.279 192.366 481.406 231.807C455.533 271.248 129.618 84.023 177.206 7.82665" stroke="#01B2E0" stroke-width="15" stroke-linecap="round" />
      </svg>
    </div>
  )
}