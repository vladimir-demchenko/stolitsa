    ...
    <div className={classNames('container', {}, [cls.hero])}>
      ...
      <div className={cls.heroGrid}>
        ...
        <p className={cls.heroText}>Образовательный и командообразующий
          палаточный слёт для молодёжного актива города Москвы. <br /><br />

          Ежегодно проводится в нестандартных условиях лесной местности в формате палаточного лагеря.</p>
