      ...
      <div className={cls.heroGrid}>
        ...
        <div className={cls.imgContainer}>
          <svg className={classNames('curves', {}, [cls.heroCurve])} xmlns="http://www.w3.org/2000/svg" width="724" height="470" viewBox="0 0 724 470" fill="none">
            <path d="M51.3262 462.368C261.441 371.141 199.211 120.937 106.992 75.0369C14.7729 29.1363 -42.403 126.924 69.1476 151.98C180.698 177.037 357.696 167.923 425.429 102.422C493.162 36.9202 302.565 -57.5397 364.989 74.8679C414.928 180.794 619.763 127.296 715.938 87.3061" stroke="#FFDE0D" stroke-width="15" stroke-linecap="round" />
          </svg>
